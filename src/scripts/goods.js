...
import {boxesImages} from "../scripts/cards.js"

const elementTemplate = document.querySelector('#card-template').content;
const newButton = document.querySelector('.goods__title');
const newButton2 = document.querySelector('.goods__title-two');
const elementPlace = document.querySelector('.goods__box');
const elementPlace2 = document.querySelector('.goods__box-two');
...
function getback2() {
    document.querySelector('.goods__title-two').textContent = 'Вернуться назад';
    document.querySelector('.goods__title-two').style.fontSize = '18px';
}
